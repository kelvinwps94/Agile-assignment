<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CustomerLogin.aspx.cs" Inherits="EzCabAssignment.CustomerLogin" %>
    ...
    <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                ...
                <h4><span class="glyphicon glyphicon-log-in"></span> Login as Customer</h4>
                <form role="form" runat="server">
                    ...
                    <div style="float: left; display: inline-block">
                        <a href="EzCabSelect.aspx">
                            <button type="button" class="btn btn-default">Back<W/button></a>
                ...
                <br />
                    ...
                    <div align="center">
                        <h5 align="center">Don't have an account yet?</h5>
                        <a href="CustomerRegister.aspx">
                            <button type="button" class="btn btn-success">Register</button></a>
                    </div>
